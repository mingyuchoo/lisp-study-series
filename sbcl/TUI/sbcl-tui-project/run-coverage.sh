...
sbcl --noinform \
     ...
     --eval "(handler-bind ((warning #'muffle-warning)) (asdf:load-system :$PROJECT_NAME :force t))" \
     --eval "(handler-bind ((warning #'muffle-warning)) (ql:quickload :${PROJECT_NAME}-tests :silent t))" \
